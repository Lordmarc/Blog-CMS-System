...
import { LogsContext } from "../activity/LogsProvider";
  ...
  return (
    <div className="recent-activity">
      ...
      <div className="relative overflow-x-auto bg-neutral-primary-soft shadow rounded-md border border-gray-300">
              ...
              <tr key={log.id} className="">
                ...
                <td>
                  <div className="flex items-center h-full">
                    <p className="bg-gray-300 rounded-full text-xs flex items-center justify-center px-3 py-[2px]  font-semibold text-gray-600">
                      {log.type}
                    </p>
                  </div>
                </td>
                <td>
                  <div className="flex items-center h-full">
                    <p
                      className={`rounded-full text-xs flex items-center justify-center px-3 py-[2px]  font-semibold ${
        ...
        {logState.activity ? (
          <button
            className="w-full bg-white border-t border-gray-300 py-4 text-[#001BB7] font-bold"
            onClick={viewAll}
          >
            {toggle ? "Show Less" : "View All Activity"}
          </button>
        ) : (
          <p>No activity yet.</p>
        )}
